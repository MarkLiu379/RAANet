...
from nets.RAANet_training import CE_Loss, Dice_loss, Focal_Loss, weights_init
...
def fit_one_epoch(model_train, model, loss_history, optimizer, epoch, epoch_step, epoch_step_val, gen, gen_val, Epoch,
    ...
    torch.save(model.state_dict(), 'deeplab_pytorch/ISPRS/da/ep%03d-loss%.3f-val_loss%.3f.pth' % (
